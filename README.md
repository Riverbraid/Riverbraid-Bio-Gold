...
**Lifecycle category:** registry listed bio-context surface
**Normative source:** Riverbraid-Core
**Claim boundary:** Declared Conditions Only

## Role in Riverbraid

Riverbraid-Bio-Gold provides biological context surface verification support within Riverbraid.

This repository is a bounded bio-context surface. It does not define canonical Riverbraid protocol semantics or certify biological, medical, safety, or compliance claims.
...
This repository does not claim certification, legal approval, production readiness, absolute security, external audit, complete AI safety, adoption, registry freshness, vulnerability freedom, security hardening, medical validity, biological validity, or absence of defects.
